...
namespace UnityEditor.ShaderGraph
{
    ...
    class ShaderGraphImporterEditor : ScriptedImporterEditor
    {
        ...
        {
            /* GetGraphData is responsible for reading the data from graph 
             * in order to generate the glsl shader from it.
             */
            GraphData GetGraphData(AssetImporter importer)
            {

                //Debug.Log(string.Format("Launched GetGraphData with argument {0}", importer.assetPath));
...
namespace AutoGen
{
    public static class graphInspectorLauncher
    {
        public static void openGraphInInspector(string path)
        {
