...
namespace UnityEditor.ShaderGraph
{
    ...
    class ColorNode : AbstractMaterialNode, IGeneratesBodyCode, IPropertyFromNode
    {
        ...
        [SerializeField]
        protected Color m_Color = new Color(UnityEngine.Color.clear, ColorMode.Default);
...
namespace AutoGen
{
    [UnityEditor.ShaderGraph.Title("Autogen", "Color (Randomizable)")]
    class RandomizableColorNode : UnityEditor.ShaderGraph.ColorNode, UnityEditor.ShaderGraph.IGeneratesBodyCode, UnityEditor.ShaderGraph.IPropertyFromNode
    {
        public RandomizableColorNode()
        {
            name = "Randomizable Color";
            UpdateNodeAfterDeserialization();
        }

    }

    [UnityEditor.ShaderGraph.Title("Autogen", "Color (Assignable)")]
    class AssignableColorNode : UnityEditor.ShaderGraph.ColorNode, UnityEditor.ShaderGraph.IGeneratesBodyCode, UnityEditor.ShaderGraph.IPropertyFromNode
    {
        public AssignableColorNode()
        {
            name = "Assignable Color";
            UpdateNodeAfterDeserialization();
        }

    }

    [UnityEditor.ShaderGraph.Title("Autogen", "Emission (Assignable)")]
    class AssignableEmissionNode : UnityEditor.ShaderGraph.ColorNode, UnityEditor.ShaderGraph.IGeneratesBodyCode, UnityEditor.ShaderGraph.IPropertyFromNode
    {
        public AssignableEmissionNode()
        {
            
            name = "Assignable Emission";
            UpdateNodeAfterDeserialization();
        }
