...
namespace UnityEditor.ShaderGraph.Drawing
{
    class MaterialGraphEditWindow : EditorWindow
    {
        ...
        // Used only when duplicating a window
        ...
        // Here the asset is loaded into a window
        public void Initialize(string assetGuid)
        {
            //Debug.Log("here graph data is generated");
            try
            {
                EditorApplication.wantsToQuit -= PromptSaveIfDirtyOnQuit;
                m_ColorSpace = PlayerSettings.colorSpace;
                ...
                //Debug.Log("GraphObject is loaded from file here");
