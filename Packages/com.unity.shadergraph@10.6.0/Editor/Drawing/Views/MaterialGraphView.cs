...
namespace UnityEditor.ShaderGraph.Drawing
{
    sealed class MaterialGraphView : GraphView, IInspectable
    {
        ...
        void ChangeTargetSettings(InspectorUpdateSource inspectorUpdateSource)
        {
            ...
            {
                Debug.LogFormat("Name:{0}",block.name);
                Debug.LogFormat("Type:{0}", block.type);
                Debug.LogFormat("DisName:{0}", block.displayName);
                Debug.LogFormat("Define:{0}", block.define);
                Debug.LogFormat("Semantic:{0}", block.semantic);
                Debug.LogFormat("Stage:{0}", block.shaderStage);
            }
