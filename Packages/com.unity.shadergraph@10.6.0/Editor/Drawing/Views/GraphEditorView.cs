...
namespace UnityEditor.ShaderGraph.Drawing
{
    ...
    class GraphEditorView : VisualElement, IDisposable
    {
        ...
        public GraphEditorView(EditorWindow editorWindow, GraphData graph, MessageManager messageManager)
        {
            ...
            //Debug.LogWarning("Here the previewmanager is created, needs a graph and a message manager");
            ...
            Add(toolbar);
            //Debug.Log("Here we make the window");
            ...
            //Debug.Log("Here the graph view is built. Nodes are linked together etc...");
            AddNodes(graph.GetNodes<AbstractMaterialNode>());
            AddBlocks(graph.GetNodes<BlockNode>());
            AddEdges(graph.edges);
            // Add the entire visual element to the root 
            Add(content);
        ...
        {
            //Debug.LogWarning("Here the master preview of the material is created, graphdata and a previewmanager are given");
